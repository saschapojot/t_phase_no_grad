...
class quadraticRing : public potentialFunction {
public:
    quadraticRing(const double &a1Val, const double &a2Val, const double& coef1Val, const double& coef2Val, const double &mAVal, const double &mBVal):potentialFunction(a1Val, a2Val, coef1Val, coef2Val, mAVal, mBVal)  {
